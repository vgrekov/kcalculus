...
_NutritionFactsPreviewFirestoreModel
    _$NutritionFactsPreviewFirestoreModelFromJson(Map<String, dynamic> json) =>
        _NutritionFactsPreviewFirestoreModel(
          per: AmountFirestoreModel.fromJson(
              json['per'] as Map<String, dynamic>),
          calories: AmountFirestoreModel.fromJson(
              json['calories'] as Map<String, dynamic>),
          fat: json['fat'] == null
              ? null
              : AmountFirestoreModel.fromJson(
