...
mixin _$NutritionRatioFirestoreModel {
  ...
  AmountFirestoreModel get total;

  /// Create a copy of NutritionRatioFirestoreModel
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $NutritionRatioFirestoreModelCopyWith<NutritionRatioFirestoreModel>
      get copyWith => _$NutritionRatioFirestoreModelCopyWithImpl<
              NutritionRatioFirestoreModel>(
          this as NutritionRatioFirestoreModel, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is NutritionRatioFirestoreModel &&
...
abstract mixin class $NutritionRatioFirestoreModelCopyWith<$Res> {
  factory $NutritionRatioFirestoreModelCopyWith(
          NutritionRatioFirestoreModel value,
          $Res Function(NutritionRatioFirestoreModel) _then) =
      _$NutritionRatioFirestoreModelCopyWithImpl;
  @useResult
  $Res call({AmountFirestoreModel per, AmountFirestoreModel total});
...
class _NutritionRatioFirestoreModel extends NutritionRatioFirestoreModel {
  const _NutritionRatioFirestoreModel({required this.per, required this.total})
      : super._();
  factory _NutritionRatioFirestoreModel.fromJson(Map<String, dynamic> json) =>
      _$NutritionRatioFirestoreModelFromJson(json);

  @override
  final AmountFirestoreModel per;
  @override
  final AmountFirestoreModel total;
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$NutritionRatioFirestoreModelCopyWith<_NutritionRatioFirestoreModel>
      get copyWith => __$NutritionRatioFirestoreModelCopyWithImpl<
          _NutritionRatioFirestoreModel>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$NutritionRatioFirestoreModelToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _NutritionRatioFirestoreModel &&
            (identical(other.per, per) || other.per == per) &&
            (identical(other.total, total) || other.total == total));
  }
...
/// @nodoc
abstract mixin class _$NutritionRatioFirestoreModelCopyWith<$Res>
    implements $NutritionRatioFirestoreModelCopyWith<$Res> {
  factory _$NutritionRatioFirestoreModelCopyWith(
          _NutritionRatioFirestoreModel value,
          $Res Function(_NutritionRatioFirestoreModel) _then) =
      __$NutritionRatioFirestoreModelCopyWithImpl;
  @override
  @useResult
  $Res call({AmountFirestoreModel per, AmountFirestoreModel total});
