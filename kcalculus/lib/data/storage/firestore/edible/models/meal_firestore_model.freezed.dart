...
mixin _$MealFirestoreModel {
  ...
  @JsonKey(fromJson: timestampToDateNotNull, toJson: dateToTimestamp)
  ...
  $MealFirestoreModelCopyWith<MealFirestoreModel> get copyWith =>
      _$MealFirestoreModelCopyWithImpl<MealFirestoreModel>(
          this as MealFirestoreModel, _$identity);
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, id, edibleId, amount, eatenAt,
...
abstract mixin class $MealFirestoreModelCopyWith<$Res> {
  factory $MealFirestoreModelCopyWith(
          MealFirestoreModel value, $Res Function(MealFirestoreModel) _then) =
      _$MealFirestoreModelCopyWithImpl;
  @useResult
  $Res call(
      {@JsonKey(includeToJson: false) String? id,
      String edibleId,
      AmountFirestoreModel amount,
      @JsonKey(fromJson: timestampToDateNotNull, toJson: dateToTimestamp)
      DateTime eatenAt,
      @JsonKey(includeToJson: false, fromJson: timestampToDate)
      DateTime? createdAt,
...
class _MealFirestoreModel extends MealFirestoreModel {
  const _MealFirestoreModel(
      {@JsonKey(includeToJson: false) this.id,
      required this.edibleId,
      ...
      : super._();
  factory _MealFirestoreModel.fromJson(Map<String, dynamic> json) =>
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$MealFirestoreModelCopyWith<_MealFirestoreModel> get copyWith =>
      __$MealFirestoreModelCopyWithImpl<_MealFirestoreModel>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$MealFirestoreModelToJson(
      this,
    );
  }
...
/// @nodoc
abstract mixin class _$MealFirestoreModelCopyWith<$Res>
    implements $MealFirestoreModelCopyWith<$Res> {
  factory _$MealFirestoreModelCopyWith(
          _MealFirestoreModel value, $Res Function(_MealFirestoreModel) _then) =
      __$MealFirestoreModelCopyWithImpl;
  @override
  @useResult
  $Res call(
      {@JsonKey(includeToJson: false) String? id,
