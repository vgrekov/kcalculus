...
@JsonKey(includeToJson: false) String? get id; String get nutrient; String get unit; double get value;@JsonKey(includeToJson: false, fromJson: timestampToDate) DateTime? get createdAt;@JsonKey(includeToJson: false, fromJson: timestampToDate) DateTime? get deletedAt;
...
@useResult
$Res call({
@JsonKey(includeToJson: false) String? id, String nutrient, String unit, double value,@JsonKey(includeToJson: false, fromJson: timestampToDate) DateTime? createdAt,@JsonKey(includeToJson: false, fromJson: timestampToDate) DateTime? deletedAt
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(includeToJson: false)  String? id,  String nutrient,  String unit,  double value, @JsonKey(includeToJson: false, fromJson: timestampToDate)  DateTime? createdAt, @JsonKey(includeToJson: false, fromJson: timestampToDate)  DateTime? deletedAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _NutrientGoalFirestoreModel() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(includeToJson: false)  String? id,  String nutrient,  String unit,  double value, @JsonKey(includeToJson: false, fromJson: timestampToDate)  DateTime? createdAt, @JsonKey(includeToJson: false, fromJson: timestampToDate)  DateTime? deletedAt)  $default,) {final _that = this;
switch (_that) {
case _NutrientGoalFirestoreModel():
...
class _NutrientGoalFirestoreModel extends NutrientGoalFirestoreModel {
  const _NutrientGoalFirestoreModel({@JsonKey(includeToJson: false) this.id, required this.nutrient, required this.unit, required this.value, @JsonKey(includeToJson: false, fromJson: timestampToDate) this.createdAt, @JsonKey(includeToJson: false, fromJson: timestampToDate) this.deletedAt}): super._();
