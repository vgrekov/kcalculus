...
mixin _$NutritionFactsDbModel {
  ...
  $NutritionFactsDbModelCopyWith<NutritionFactsDbModel> get copyWith =>
      _$NutritionFactsDbModelCopyWithImpl<NutritionFactsDbModel>(
          this as NutritionFactsDbModel, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is NutritionFactsDbModel &&
...
abstract mixin class $NutritionFactsDbModelCopyWith<$Res> {
  factory $NutritionFactsDbModelCopyWith(NutritionFactsDbModel value,
          $Res Function(NutritionFactsDbModel) _then) =
      _$NutritionFactsDbModelCopyWithImpl;
  @useResult
  $Res call(
...
class _NutritionFactsDbModel implements NutritionFactsDbModel {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$NutritionFactsDbModelCopyWith<_NutritionFactsDbModel> get copyWith =>
      __$NutritionFactsDbModelCopyWithImpl<_NutritionFactsDbModel>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$NutritionFactsDbModelToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _NutritionFactsDbModel &&
            (identical(other.id, id) || other.id == id) &&
            (identical(other.edible_id, edible_id) ||
                other.edible_id == edible_id) &&
            (identical(other.amount_unit, amount_unit) ||
...
/// @nodoc
abstract mixin class _$NutritionFactsDbModelCopyWith<$Res>
    implements $NutritionFactsDbModelCopyWith<$Res> {
  factory _$NutritionFactsDbModelCopyWith(_NutritionFactsDbModel value,
          $Res Function(_NutritionFactsDbModel) _then) =
      __$NutritionFactsDbModelCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String id, String edible_id, String amount_unit, double amount_value});
