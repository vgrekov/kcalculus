...
class NutrientGoalListViewModel
  ...
  FutureOr<List<NutrientGoal>> build() async {
    ...
    final nutrientGoalRepository =
        ref.read(nutrientGoalRepositoryProvider.notifier);
  ...
  Future<void> saveGoal(NutrientGoal goal) async {
    ...
    try {
      ...
      await ref.read(nutrientGoalRepositoryProvider.notifier).save(goal);
  ...
  Future<void> restoreGoal(NutrientGoal goal) async {
    ...
    try {
      ...
      await ref.read(nutrientGoalRepositoryProvider.notifier).restore(goal.id!);
