...
mixin _$NutrientStatsRow {
 ...
 Nutrient get nutrient; Amount get amount; Amount? get goalAmount; int get level;
...
@override
int get hashCode => Object.hash(runtimeType,nutrient,amount,goalAmount,level);

@override
String toString() {
  return 'NutrientStatsRow(nutrient: $nutrient, amount: $amount, goalAmount: $goalAmount, level: $level)';
}
...
@useResult
$Res call({
 Nutrient nutrient, Amount amount, Amount? goalAmount, int level
});
...
/// Create a copy of NutrientStatsRow
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? nutrient = null,Object? amount = null,Object? goalAmount = freezed,Object? level = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( Nutrient nutrient,  Amount amount,  Amount? goalAmount,  int level)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _NutrientStatsRow() when $default != null:
return $default(_that.nutrient,_that.amount,_that.goalAmount,_that.level);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( Nutrient nutrient,  Amount amount,  Amount? goalAmount,  int level)  $default,) {final _that = this;
switch (_that) {
case _NutrientStatsRow():
return $default(_that.nutrient,_that.amount,_that.goalAmount,_that.level);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( Nutrient nutrient,  Amount amount,  Amount? goalAmount,  int level)?  $default,) {final _that = this;
switch (_that) {
case _NutrientStatsRow() when $default != null:
return $default(_that.nutrient,_that.amount,_that.goalAmount,_that.level);case _:
  return null;
...
class _NutrientStatsRow implements NutrientStatsRow {
  const _NutrientStatsRow({required this.nutrient, required this.amount, this.goalAmount, required this.level});
...
/// Create a copy of NutrientStatsRow
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? nutrient = null,Object? amount = null,Object? goalAmount = freezed,Object? level = null,}) {
